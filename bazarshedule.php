        ...
        $date1=mysqli_real_escape_string($ob->link,$date1);
         $name=mysqli_real_escape_string($ob->link,$name);
          $phone=mysqli_real_escape_string($ob->link,$phone);
                    ...
                    $query1="INSERT INTO bazardate(email,date1,name,phone) VALUES('$email','$date1','$name','$phone') ";
                    $result=$ob->insert($query1);
                    
                  if($result){
                    $msg="<div class='alert alert-success'><span>Bazar Date Add Successfully</span></div>";
...
<div class="basic">
  ...
  <div class="basic"  >
      <h3 style="text-align:center;padding: 13px;">Add Bazar Schedule</h3>
      </div>
<div class="addform">
  
  <h4>Today Date:<?php echo date('d/m/y');?></h4>
  ...
  <div class="form-group">
    <label for="pwd">Phone<span style="color:red">*</span> </label>
    <select name="phone" class="custom-select form-control mr-sm-2" required="" id="category">
    <option value="" >Phone<span style="color:red;">*</span> (Must be Careful When Select)</option>
   <?php  
  ...
  <div class="form-group">
    <label for="pwd">Fix Bazar Date </label>
    
  
  <input class="form-control"  name="date1" required="" placeholder="Date Format Must Be like this <?php echo date('d/m/y') ?>.... OR <?php echo date('d/m/y') ?>--<?php echo date('d/m/y') ?>">
